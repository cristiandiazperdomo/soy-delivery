...
export const Testimonies = () => {
    return (
        <section class="w-full flex flex-col items-center gap-x-4 container mx-auto text-gray-700 space-y-12 pb-20 px-4 z-10">
                ...
                <div className="relative w-full flex items-start md:items-center justify-center">
                    <div className="hidden md:flex transition-all duration-100 p-2 hover:shadow-xl rounded-full cursor-pointer">
                        <svg
                            ...
                            class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-left w-[40px] h-[40px]"
                        >
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-4">
                            <div className="flex md:hidden transition-all duration-100 p-2 hover:shadow-xl rounded-full cursor-pointer">
                                <svg
                                    ...
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-left w-[28px] sm:w-[40px] h-[28px] sm:h-[40px]"
                                >
                                    <path
                                        stroke="none"
                                        d="M0 0h24v24H0z"
                            ...
                            <div className="flex md:hidden transition-all duration-100 p-2 hover:shadow-xl rounded-full cursor-pointer">
                                <svg
                                    ...
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-right w-[28px] sm:w-[40px] h-[28px] sm:h-[40px]"
                                >
                                    <path
                                        stroke="none"
                                        d="M0 0h24v24H0z"
                        ...
                        <div className="flex">
                            {[1, 2, 3, 4, 5].map(() => (
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    class="icon icon-tabler icons-tabler-filled icon-tabler-star w-[20px] h-[20px] text-orange-400"
                                >
                                    <path
                                        stroke="none"
                                        d="M0 0h24v24H0z"
                        ...
                        <div className="relative w-full h-[120px] flex justify-center">
                            ...
                            <div className="transition-all duration-100 flex justify-between absolute -top-4 left-0 z-10 opacity-20 w-full">
                                <svg
                                    ...
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="icon icon-tabler icons-tabler-outline icon-tabler-quote w-16 h-16 right-0 rotate-180 opacity-50 sm:opacity-100"
                                >
                                    <path
                                        stroke="none"
                                        d="M0 0h24v24H0z"
                            ...
                            <div className="transition-all duration-100 flex justify-between absolute bottom-0 right-0 z-10 opacity-20">
                                <svg
                                    ...
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="icon icon-tabler icons-tabler-outline icon-tabler-quote w-16 h-16 right-0 opacity-50 sm:opacity-100"
                                >
                                    <path
                                        stroke="none"
                                        d="M0 0h24v24H0z"
                    ...
                    <div className="hidden md:flex transition-all duration-100 p-2 hover:shadow-xl rounded-full cursor-pointer">
                        <svg
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-right w-[40px] h-[40px]"
                        >
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M5 12l14 0" />
                            <path d="M13 18l6 -6" />
