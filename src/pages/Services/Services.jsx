...
import flota from "../../assets/flota.jpg";
                ...
                <div className="px-4 lg:px-0">
                    ...
                    <div className="py-20 text-center">
                        <div className="container mx-auto space-y-4">
                            <p class="space-x-1.5 text-xs tracking-tight font-bold text-orange-500">
                                <span>¿ P O R Q U É </span>
                                <span>E L E G I R</span>
                                <span>S O Y</span>
                                <span>D E L I V E R Y ?</span>
                            </p>
                            <h2 class="pb-12 text-3xl sm:text-5xl tracking-tight font-semibold text-gray-900">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 xl:gap-y-0 xl:gap-x-2 text-left">
                                ...
                                >
                                    <svg
                                        ...
                                        class="icon icon-tabler icons-tabler-outline icon-tabler-package w-[48px] h-[48px]"
                                        style={{color: "#001F3F"}}
                                    >
                                        <path
                                            stroke="none"
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p class="mb-3 font-light text-gray-50">
                                ...
                                <div className="flex flex-col items-start space-y-4 w-full h-full p-6 bg-gray-50 h-[300px]">
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="icon icon-tabler icons-tabler-outline icon-tabler-package w-[48px] h-[48px] text-gray-400"
                                    >
                                        <path
                                            stroke="none"
                                            d="M0 0h24v24H0z"
