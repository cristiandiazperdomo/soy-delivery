...
export const Home = () => {
    return (
        <div className="min-h-screen text-white">
            ...
            <section class="grid grid-cols-1 lg:grid-cols-2 gap-x-4 container mx-auto min-h-screen px-4">
                <div class="py-8 max-w-screen-xl sm:py-16">
                    <div class="">
                        <p class="space-x-1.5 mb-3 text-xs tracking-tight font-bold text-orange-500">
                            <span>¿ P O R Q U É </span>
                            <span>E L E G I R</span>
                            <span>S O Y</span>
                            <span>D E L I V E R Y ?</span>
                        </p>
                        <h2 class="mb-8 text-3xl sm:text-5xl tracking-tight font-extrabold text-gray-900">
                            Descubre nuestros servicios logísticos
                            personalizados
                        </h2>
                        <p class="mb-10 font-light text-gray-500 sm:text-xl">
                ...
                <div className="flex flex-col lg:mt-20 space-y-8">
                    <div className="flex space-x-6">
                        <svg
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-clock-hour-4 text-orange-500 min-w-[48px] w-[48px] min-h-[48px] h-[48px]"
                        >
                        ...
                        <div className="mt-2">
                            <p class="mb-3 text-2xl tracking-tight font-bold text-gray-900">
                    ...
                    <div className="flex space-x-6">
                        <svg
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-package text-orange-500 min-w-[48px] w-[48px] min-h-[48px] h-[48px]"
                        >
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div className="flex space-x-6">
                        <svg
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-map-2 text-orange-500 min-w-[48px] w-[48px] min-h-[48px] h-[48px]"
                        >
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div className="flex space-x-6">
                        <svg
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-forklift text-orange-500 min-w-[48px] w-[48px] min-h-[48px] h-[48px]"
                        >
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div className="bg-gray-50 px-4 pt-12 lg:pt-20 mt-8 lg:mt-0">
                <section class="w-full flex flex-col items-center gap-x-4 container mx-auto text-gray-700 space-y-12 pb-20 px-4">
